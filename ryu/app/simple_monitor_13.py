...
class SimpleMonitor13(app_manager.RyuApp):
    ...
    @set_ev_cls(bobi_event.EventOFPFlowStatsReply, MAIN_DISPATCHER)
    ...
    @set_ev_cls(bobi_event.EventOFPPortStatsReply, MAIN_DISPATCHER)
    ...
    @set_ev_cls(bobi_event.EventOFPSwitchFeatures, CONFIG_DISPATCHER)
