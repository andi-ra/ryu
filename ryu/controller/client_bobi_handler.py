...
class ClientOFPHandler(ryu.base.app_manager.RyuApp):
    def __init__(self, *args, **kwargs):
        super(ClientOFPHandler, self).__init__(*args, **kwargs)
        self.client_addr = {}
    ...
    @set_ev_handler(ofp_event.EventOFPHello, [HANDSHAKE_DISPATCHER, CONFIG_DISPATCHER])
        ...
        if elements:
            ...
            if negotiated_versions and not usable_versions:
                ...
                error_desc = (
                        ...
                        'switch versions %s client_server version 0x%x, '
            ...
            if (negotiated_versions and usable_versions and
                ...
                error_desc = (
                        'no compatible version found: '
                        'switch versions 0x%x client_server version 0x%x, '
            ...
            if (usable_versions and
                ...
                error_desc = (
                        'no compatible version found: '
                        'switch 0x%x client_server 0x%x, but found usable 0x%x. '
